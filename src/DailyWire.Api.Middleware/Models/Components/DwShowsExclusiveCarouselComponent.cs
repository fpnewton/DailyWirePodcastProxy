...
public class DwShowsExclusiveCarouselComponent : DwComponent
{
    public override DwComponentRenderType RenderType => DwComponentRenderType.ShowsExclusiveCarousel;
